...
class GlobalDataPullLog(Base):
    ...
    resulting_company_id = Column(String(36), ForeignKey("companies.id"), nullable=True)
    resulting_contact_id = Column(String(36), ForeignKey("contacts.id"), nullable=True)
    resulting_lead_id = Column(String(36), ForeignKey("leads.id"), nullable=True)
